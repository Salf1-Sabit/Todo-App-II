...
import { Drawer, Box, AppBar, Toolbar, Badge, Tooltip } from "@mui/material";
    ...
    <div>
      ...
      <List>
        <ListItem disablePadding>
          <ListItemButton>
            <ListItemIcon>
              <WorkspacesIcon sx={{ color: "#5762E3" }} />
            </ListItemIcon>
